...
<style type="text/css">
	...
	.titulosite{position: absolute;top:80px;left: 34%;}
    ...
    @media all and (min-width: 800px){
      .titulosite{position: absolute;top:80px;left: 37%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }

    @media all and (min-width: 960px){
      .titulosite{position: absolute;top:80px;left: 39%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }
    ...
    @media all and (min-width: 1280px){
      .titulosite{position: absolute;top:80px;left: 41%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }
...
<div class="container-fluid">
  ...
  <div class="titulosite">
    <center><label >PERMISSÕES <br> EDITAR GRUPO </label></center>
  </div>
