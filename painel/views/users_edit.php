...
<style type="text/css">
	...
	<?php endif; ?>
	 ...
	 .titulosite{position: absolute;top:100px;left: 29%;}
    ...
    @media all and (min-width: 768px){
      .titulosite{position: absolute;top:100px;left: 31%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }

    @media all and (min-width: 800px){
      .titulosite{position: absolute;top:100px;left: 32%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }
    ...
    @media all and (min-width: 1024px){
      .titulosite{position: absolute;top:100px;left: 36%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }

    @media all and (min-width: 1280px){
      .titulosite{position: absolute;top:100px;left: 39%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }
...
<div class="container-fluid">
  ...
  <div class="titulosite">
    <center><label >ÚSUARIOS - EDITAR</label></center>
  </div>
...
<form method="post" class="form">
	...
	<input type="password" autocomplete="off" name="password" id="password" placeholder="Senha do Usuário" autofocus="autofocus" class="form-control"><br/>
