...
<div class="container-fluid">
  ...
  <div class="titulosite">
    <center><label >ADICIONAR - PRÊMIO</label></center>
  </div>
...
<form method="POST" class="form" enctype="multipart/form-data" >
  ...
  <input type="file" name="imagempremio" id="imagempremio" placeholder="Imagem Prêmio" autofocus="autofocus" class="form-control" required="required" ><br/>

  <label for="name" class="title">Nome do Prêmio</label><br/>
  <input type="text" name="name" id="name" placeholder="Nome do Prêmio" autofocus="autofocus" class="form-control" required="required"><br/>

  <label for="name" class="title">Quantidade em Estoque</label><br/>
  <input type="text" name="quantestoque" onkeyup="somenteNumerosInteiros(this);" id="quantestoque" placeholder="0" autofocus="autofocus" class="form-control" required="required"><br/>

  <label for="pontos" class="title">Quantos Pontos</label><br/>
  <input type="text" autocomplete="off" onkeyup="somenteNumeros(this);" name="pontos" id="pontos" placeholder="0" autofocus="autofocus" class="form-control" required="required"><br/>
