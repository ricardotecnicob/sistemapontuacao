...
<style type="text/css">
	...
	<?php endif; ?>
	 ...
	 .titulosite{position: absolute;top:80px;left: 23%;}
    ...
    @media all and (min-width: 768px){
      .titulosite{position: absolute;top:80px;left: 26%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }

    @media all and (min-width: 800px){
      .titulosite{position: absolute;top:80px;left: 28%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }
    ...
    @media all and (min-width: 1366px){
      .titulosite{position: absolute;top:80px;left: 36%;}
      .titulosite label{font-size: 2.5em;margin-top: 50px;}
    }
...
<div class="container-fluid">
  ...
  <div class="titulosite">
    <center><label >PERMISSÕES - ADICIONAR</label></center>
  </div>
...
<form method="post" class="form">
  ...
  <input type="text" name="descricion" id="descricion" placeholder="Descrição da Permissão" autofocus="autofocus" class="form-control" required="required">
